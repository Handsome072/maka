...
export function AdminHosts({ onNavigate }: AdminHostsProps) {
  const hosts = [
    {
      id: 1,
      name: 'Jean Dupont',
  ...
  const getTypeColor = (type: string) => {
    if (type === 'SUPER HOST') return 'bg-emerald-100 text-emerald-700';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <AdminSidebar currentPage="admin-hosts" onNavigate={onNavigate} />
              ...
              <div key={host.id} className="p-4 hover:bg-gray-50 transition-colors">
                ...
                <div className="grid grid-cols-2 gap-3 mb-3 text-sm">
                  ...
                  <div>
                    ...
                    <div className="text-sm" style={{ fontWeight: 600, color: '#10B981' }}>{host.revenue}</div>
                  </div>
                </div>
