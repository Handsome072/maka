...
export function AdminRefunds({ onNavigate }: AdminRefundsProps) {
  const refunds = [
    {
      id: '#REF-001',
      reservation: '#RES-005',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <AdminSidebar currentPage="admin-refunds" onNavigate={onNavigate} />
      ...
      <main className="lg:ml-[280px] p-4 md:p-6 lg:p-8">
        ...
        <div className="bg-white rounded-xl shadow-sm">
              ...
              <tbody>
                {refunds.map((refund) => (
                  <tr key={refund.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-4 px-6 text-sm" style={{ fontWeight: 600, color: '#10B981' }}>{refund.reservation}</td>
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-emerald-600 rounded-full flex items-center justify-center text-white text-xs" style={{ fontWeight: 600 }}>
                    ...
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-2">
                        <div className="w-8 h-8 bg-emerald-600 rounded-full flex items-center justify-center text-white text-xs" style={{ fontWeight: 600 }}>
                          {refund.host.avatar}
                        </div>
            ...
            {refunds.map((refund) => (
              <div key={refund.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between mb-3">
                  <span className="text-sm" style={{ fontWeight: 600, color: '#10B981' }}>{refund.id}</span>
                ...
                <div className="flex items-start gap-3 mb-3">
                  <div className="w-12 h-12 bg-emerald-600 rounded-full flex items-center justify-center text-white flex-shrink-0" style={{ fontWeight: 600 }}>
                    {refund.client.avatar}
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div>
                    ...
                    <div className="text-xs" style={{ fontWeight: 600, color: '#10B981' }}>{refund.reservation}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-emerald-600 rounded-full flex items-center justify-center text-white text-xs" style={{ fontWeight: 600 }}>
                        {refund.host.avatar}
                      </div>
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-gray-100">
                  ...
                  <button className="flex-1 px-3 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-colors flex items-center justify-center gap-2">
          ...
          <div className="p-6 flex items-center justify-center gap-2">
            ...
            <button className="px-4 py-2 bg-emerald-600 text-white rounded-lg" style={{ fontWeight: 600 }}>1</button>
