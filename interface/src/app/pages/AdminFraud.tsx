...
export function AdminFraud({ onNavigate }: AdminFraudProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <AdminSidebar currentPage="admin-fraud" onNavigate={onNavigate} />
          ...
          <div className="border-b border-gray-200">
            <div className="flex items-center gap-4 md:gap-6 px-4 md:px-6 overflow-x-auto">
              ...
              >
                ...
                <span className="inline-block px-2 py-1 bg-emerald-100 text-emerald-600 rounded text-xs" style={{ fontWeight: 600 }}>
                  4
                </span>
              </button>
              <button
                ...
                {(activeTab === 'host' ? hostIncidents : clientIncidents).map((incident) => (
                  <tr key={incident.id} className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="py-4 px-6">
                      <span className="text-sm text-emerald-600" style={{ fontWeight: 600 }}>{incident.id}</span>
                    </td>
                    <td className="py-4 px-6">
                      <div className="flex items-center gap-3">
