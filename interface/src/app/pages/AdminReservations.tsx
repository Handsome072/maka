...
export function AdminReservations({ onNavigate }: AdminReservationsProps) {
  const reservations = [
    {
      id: '#RES-001',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <AdminSidebar currentPage="admin-reservations" onNavigate={onNavigate} />
              ...
              <tbody>
                {reservations.map((reservation) => (
                  <tr key={reservation.id} className="border-b border-gray-100 hover:bg-gray-50">
                    <td className="py-4 px-6 text-sm" style={{ fontWeight: 600, color: '#10B981' }}>{reservation.id}</td>
            ...
            {reservations.map((reservation) => (
              <div key={reservation.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between mb-3">
                  <span className="text-sm" style={{ fontWeight: 600, color: '#10B981' }}>{reservation.id}</span>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm" style={{ fontWeight: 600, color: '#10B981' }}>{reservation.amount}</div>
                  </div>
                  <div>
