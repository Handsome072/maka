              ...
              <tbody>
                {payments.map((payment) => (
                  <tr key={payment.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-4 px-6 text-sm" style={{ fontWeight: 600, color: '#10B981' }}>{payment.reservation}</td>
            ...
            {payments.map((payment) => (
              <div key={payment.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between mb-3">
                  <span className="text-sm" style={{ fontWeight: 600, color: '#10B981' }}>{payment.id}</span>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div>
                    ...
                    <div className="text-xs" style={{ fontWeight: 600, color: '#10B981' }}>{payment.reservation}</div>
                  </div>
                  <div>
