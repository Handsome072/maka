import { Search, Users, Home, DollarSign, Eye, Edit, Trash2 } from 'lucide-react';
...
export function AdminProperties({ onNavigate }: AdminPropertiesProps) {
  const properties = [
    {
      id: 1,
      name: 'Villa Toscane',
  ...
  const getTypeColor = (type: string) => {
    if (type === 'VILLA') return 'bg-emerald-100 text-emerald-700';
    if (type === 'APPARTEMENT') return 'bg-teal-100 text-teal-700';
    if (type === 'CHALET') return 'bg-orange-100 text-orange-700';
    if (type === 'STUDIO') return 'bg-emerald-100 text-emerald-700';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <AdminSidebar currentPage="admin-properties" onNavigate={onNavigate} />
              ...
              <div key={property.id} className="p-4 hover:bg-gray-50 transition-colors">
                ...
                <div className="grid grid-cols-2 gap-3 mb-3 text-sm">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="text-base" style={{ fontWeight: 600, color: '#10B981' }}>{property.price}</div>
                  </div>
                </div>
