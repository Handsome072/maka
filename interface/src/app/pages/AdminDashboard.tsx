...
export function AdminDashboard({ onNavigate }: AdminDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <AdminSidebar currentPage="admin-dashboard" onNavigate={onNavigate} />
      ...
      <main className="lg:ml-[280px] p-4 md:p-6 lg:p-8">
          ...
          <div className="flex items-center gap-4">
            <div className="relative flex-1 sm:flex-initial">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 w-full sm:w-80"
              />
            </div>
        ...
        <div className="bg-white rounded-xl p-4 md:p-6 shadow-sm">
          <div className="flex items-center justify-between mb-6">
            ...
            <button className="text-sm text-emerald-600 hover:underline" style={{ fontWeight: 500 }}>
              Voir tout
            </button>
          </div>
            ...
            {recentBookings.map((booking) => (
              <div key={booking.id} className="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between mb-3">
                  <span className="text-sm" style={{ fontWeight: 600, color: '#10B981' }}>{booking.id}</span>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-gray-200">
                    ...
                    <span className="text-base" style={{ fontWeight: 600, color: '#10B981' }}>{booking.montant}</span>
                  </div>
                </div>
              </div>
            ))}
