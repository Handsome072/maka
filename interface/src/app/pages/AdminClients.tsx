...
export function AdminClients({ onNavigate }: AdminClientsProps) {
  const clients = [
    {
      id: 1,
      name: 'Jean Dupont',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <AdminSidebar currentPage="admin-clients" onNavigate={onNavigate} />
              ...
              <div key={client.id} className="p-4 hover:bg-gray-50 transition-colors">
                ...
                <div className="grid grid-cols-2 gap-3 mb-3 text-sm">
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="text-sm" style={{ fontWeight: 600, color: '#10B981' }}>{client.totalSpent}</div>
                  </div>
                </div>
