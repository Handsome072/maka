...
interface ExperienceGuestsPickerProps {
  onClose: () => void;
  onGuestsChange?: (guests: { adults: number; children: number; babies: number }) => void;
  currentGuests?: { adults: number; children: number; babies: number };
}

export function ExperienceGuestsPicker({ onClose, onGuestsChange, currentGuests }: ExperienceGuestsPickerProps) {
