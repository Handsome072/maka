...
// import logo from "figma:asset/71ec6463a41bb19e85fad23a7af09392bb3b16a7.png";
      ...
      <div className="px-4 sm:px-6 lg:px-20 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-16 mb-12">
          ...
          <div className="mb-10 flex flex-col items-start gap-3">
            <div className="h-12 w-12 flex items-center justify-center rounded-lg bg-[#10B981]/10">
              <Home className="h-8 w-8 text-[#10B981]" strokeWidth={2} />
            </div>
