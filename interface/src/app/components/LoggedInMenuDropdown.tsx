import { Heart, Globe, MessageSquare, User, Settings, HelpCircle, Shield, ShieldCheck } from 'lucide-react';
import { useEffect, useRef } from 'react';
// import hostIllustration from 'figma:asset/38ec71431adff7f609dab055e5554ab5c0ee6be7.png';
...
export function LoggedInMenuDropdown({ isOpen, onClose, onBecomeHostClick, onLanguageClick, onClientSpaceClick, onMessagesClick, onAdminClick }: LoggedInMenuDropdownProps) {
    ...
    >
      ...
      >
        <div className="flex items-start justify-between gap-3 px-4">
          ...
          <ShieldCheck className="w-10 h-10 text-[#10B981] flex-shrink-0" strokeWidth={1.5} />
        </div>
      </button>
