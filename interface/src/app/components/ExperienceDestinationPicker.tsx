...
interface ExperienceDestinationPickerProps {
  onClose: () => void;
...
export function ExperienceDestinationPicker({ onClose, onSelect }: ExperienceDestinationPickerProps) {
  ...
  return (
    ...
    >
      <div className="max-h-[420px] overflow-y-auto px-6 py-6 scrollbar-thin">
