...
interface HeaderProps {
  ...
  onNavigate: (
    page: "logements" | "experiences" | "services" | "messages" | "host-onboarding" | "annonces" | "experience-onboarding" | "admin-dashboard" | "admin-fraud" | "admin-clients" | "admin-hosts" | "admin-disputes" | "admin-properties" | "admin-reservations" | "admin-payments" | "admin-refunds" | "service-creation",
  ) => void;
  isScrolled: boolean;
          ...
          <div className="px-4 sm:px-6 lg:px-20 py-4">
            <div className="flex items-center justify-between relative">
              ...
              <HeaderRightMenu
                ...
                onAdminClick={() => onNavigate('admin-dashboard')}
              />
            </div>
          </div>
        </header>
