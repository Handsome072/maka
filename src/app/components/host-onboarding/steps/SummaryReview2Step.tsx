...
export function SummaryReview2Step() {
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 border border-gray-100 rounded-xl overflow-hidden">
              ...
              <div className="bg-white">
                {[
                  { label: "Photo de l'hôte", step: 'host-photo' as Step },
                  { label: "Photos du chalet", step: 'chalet-photos' as Step },
                  { label: "Description du chalet", step: 'chalet-description' as Step },
                ].map((item, idx) => (
