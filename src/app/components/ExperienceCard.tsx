  ...
  return (
    <div className="group cursor-pointer flex-shrink-0 w-full" onClick={handleClick}>
      <div className="relative aspect-square rounded-xl overflow-hidden mb-3">
        ...
        {/* Badge Populaire ou Originals */}
        {badge && (
          <div className={`absolute top-3 left-3 px-3 py-1 rounded-md shadow-sm flex items-center gap-1.5 ${
        ...
        {/* Horaire */}
        {time && (
          <div className="absolute bottom-3 left-3 bg-white px-2.5 py-1 rounded shadow-sm">
            <span className="text-xs" style={{ fontWeight: 600 }}>{time}</span>
          </div>
        )}
      </div>
