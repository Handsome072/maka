...
export function AdminRefunds() {
  const refunds = [
    ...
    },
    {
      ...
      date: '25/02/2025',
      status: 'EN ATTENTE',
      statusColor: 'bg-[#111827]/20 text-[#111827]'
    },
    {
      id: '#REF-005',
      reservation: '#RES-020',
              ...
              <tbody>
                {refunds.map((refund) => (
                  <tr key={refund.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-4 px-6 text-sm" style={{ fontWeight: 600, color: '#111827' }}>{refund.reservation}</td>
            ...
            {refunds.map((refund) => (
              <div key={refund.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex items-start justify-between mb-3">
                  <span className="text-sm" style={{ fontWeight: 600, color: '#111827' }}>{refund.id}</span>
                ...
                <div className="grid grid-cols-2 gap-3 mb-3">
                  <div>
                    ...
                    <div className="text-xs" style={{ fontWeight: 600, color: '#111827' }}>{refund.reservation}</div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 bg-[#111827] rounded-full flex items-center justify-center text-white text-xs" style={{ fontWeight: 600 }}>
                        {refund.host.avatar}
                      </div>
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-gray-100">
                  ...
                  <button className="flex-1 px-3 py-2 bg-[#111827] text-white rounded-lg hover:bg-[#1f2937] transition-colors flex items-center justify-center gap-2">
