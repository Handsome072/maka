...
export function Services({ isScrolled, onServiceClick, onSearch }: ServicesProps) {
  ...
  const chefsPrivesSection = [
    {
      ...
      price: "À partir de 85 C$ par voyageur",
      rating: 4.57
    },
    {
      id: "2",
    ...
    },
    {
      ...
      host: "Hôte particulier",
      price: "À partir de 39 C$ par voyageur",
      rating: 5.0
    },
    {
      id: "4",
      ...
      host: "Hôte professionnel",
      price: "À partir de 72 C$ par voyageur",
      rating: 5.0
    },
    {
      id: "5",
      ...
      host: "Hôte particulier",
      price: "À partir de 65 C$ par voyageur",
      rating: 5.0
    },
    {
      id: "6",
    ...
    },
    {
      ...
      host: "Hôte particulier",
      price: "À partir de 67 C$ par voyageur",
      rating: 5.0
    }
  ];
  ...
  const massageServices = [
    ...
    },
    {
      ...
      host: "Hôte particulier",
      price: "À partir de 80 C$ par groupe",
      rating: 5.0
    },
    {
      id: "13",
    ...
    },
    {
      ...
      host: "Hôte particulier",
      price: "À partir de 88 C$ par voyageur",
      rating: 4.0
    }
  ];
  ...
  const coachingServices = [
    {
      ...
      host: "Hôte professionnel",
      price: "À partir de 60 C$ par séance",
      rating: 5.0
    },
    {
      id: "16",
      ...
      host: "Hôte particulier",
      price: "À partir de 50 C$ par séance",
      rating: 4.9
    },
    {
      id: "17",
      ...
      host: "Hôte professionnel",
      price: "À partir de 75 C$ par séance",
      rating: 5.0
    },
    {
      id: "18",
      ...
      host: "Hôte professionnel",
      price: "À partir de 65 C$ par séance",
      rating: 4.95
    },
    {
      id: "19",
      ...
      host: "Hôte particulier",
      price: "À partir de 70 C$ par séance",
      rating: 4.88
    },
    {
      id: "20",
      ...
      host: "Hôte professionnel",
      price: "À partir de 40 C$ par séance",
      rating: 5.0
    },
    {
      id: "21",
      ...
      host: "Hôte particulier",
      price: "À partir de 55 C$ par séance",
      rating: 4.92
    }
  ];
