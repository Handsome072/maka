          ...
          <div className="flex gap-12">
            ...
            <div className="flex-1 max-w-3xl">
              ...
              <p className="text-base mb-6 leading-relaxed" style={{ color: '#222222' }}>
                Veuillez noter que Séjoura ne s'engage ni ne s'oblige à utiliser un dispositif alternatif de résolution des litiges au sens de la directive 2013/11 UE afin de résoudre des litiges avec les consommateurs.
              </p>

              <p className="text-base mb-6 leading-relaxed" style={{ color: '#222222' }}>
                <strong>L'article 25 des présentes Conditions contient un contrat d'arbitrage et de renonciation de recours collectif qui s'appliquent à toute demande d'indemnisation engagée contre Séjoura aux États-Unis. Veuillez les lire attentivement.</strong>
              </p>
              ...
              <div className="space-y-8 mb-12">
                ...
                <div className="text-base leading-relaxed space-y-1" style={{ color: '#222222' }}>
                  ...
                  <p>Séjoura Payments UK Ltd. est autorisé et régulé par l'Autorité de bonne conduite financière (Financial Conduct Authority) en tant qu'établissement de monnaie électronique sous la référence 900596.</p>
                </div>
                ...
                <div className="text-base leading-relaxed space-y-1" style={{ color: '#222222' }}>
                  ...
                  <p>Séjoura Payments Luxembourg S.A. est autorisée et régulée par la Commission de Surveillance du Secteur Financier (« CSSF ») sous le numéro de référence Z21.</p>
                </div>
