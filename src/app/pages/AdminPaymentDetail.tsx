...
const paymentDetails: Record<string, PaymentDetail> = {
  'PAY-10001': {
    ...
    history: [
      { date: '2025-03-18T09:00:00', action: 'Payout verse', actor: 'Systeme', details: 'Virement de 1 710,20 € vers le compte de Jean Dupont' },
      { date: '2025-03-15T14:32:00', action: 'Paiement reussi', actor: 'Systeme', details: 'Paiement de 2 012,00 € par carte bancaire Visa •••• 4242' },
  ...
  'PAY-10005': {
    ...
    history: [
      ...
      { date: '2025-03-10T14:00:00', action: 'Remboursement total', actor: 'Admin (Marie Admin)', details: 'Remboursement de 2 597,00 € suite a annulation' },
      { date: '2025-03-08T10:15:00', action: 'Paiement reussi', actor: 'Systeme', details: 'Paiement de 2 597,00 € par Stripe' },
