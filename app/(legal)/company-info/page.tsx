...
export const metadata: Metadata = {
  title: 'Mentions Légales | Séjoura',
  description: 'Mentions légales de la plateforme Séjoura - WANDERLATE SASU',
};
      ...
      <div className="px-6 lg:px-20 py-12">
        <div className="max-w-[800px] mx-auto">
          ...
          <p className="text-base mb-8" style={{ color: '#222222', lineHeight: '1.6' }}>
            Conformément aux dispositions de la loi n°2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique (LCEN), il est précisé aux utilisateurs du site Séjoura l'identité des différents intervenants dans le cadre de sa réalisation et de son exploitation.
          </p>
          ...
          <div className="space-y-8 text-base" style={{ color: '#222222', lineHeight: '1.6' }}>
            ...
            <section>
              ...
              <p className="mb-4">Le site Séjoura est édité et exploité par :</p>
              <div className="mb-4">
              ...
              <p>Séjoura est une marque commerciale exploitée par WANDERLATE SASU.</p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                Séjoura est une plateforme de réservation en ligne permettant la mise en relation entre des utilisateurs et des hébergeurs professionnels ou particuliers pour la réservation d'hébergements touristiques.
              </p>
              <p>
                Séjoura intervient exclusivement en qualité de plateforme intermédiaire de réservation et n'est ni propriétaire, ni exploitant des hébergements proposés, sauf mention contraire explicite.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                WANDERLATE SASU, exploitant de la plateforme Séjoura, s'efforce d'assurer l'exactitude et la mise à jour des informations diffusées sur le site. Toutefois, elle ne saurait être tenue responsable :
              </p>
            ...
            <section>
              ...
              <p className="mb-4">
                L'ensemble des éléments constituant le site Séjoura (textes, graphismes, logos, marques, interfaces, bases de données, structure générale) est protégé par le droit de la propriété intellectuelle.
              </p>
              <p>
            ...
            <section>
              ...
              <p className="mb-4">
                Les données personnelles collectées via la plateforme Séjoura sont traitées conformément à la réglementation en vigueur, notamment le Règlement Général sur la Protection des Données (RGPD).
              </p>
              <p className="mb-4">
            ...
            <section>
              ...
              <p className="mb-4">
                Le site Séjoura utilise des cookies et technologies similaires afin d'améliorer l'expérience utilisateur, mesurer l'audience et sécuriser les services.
              </p>
              <p>
